...
import com.joblink.joblink.dao.JobSkillDao;
...
public class JobSearchService {
    ...
    private final EmployerProfileDao companyDao;
    private final SubscriptionDao subscriptionDao;


    public JobSearchService(JobSearchDao jobSearchDao, JobSkillDao jobSkillDao, EmployerProfileDao companyDao, SubscriptionDao subscriptionDao) {
    ...
    public List<Map<String, Object>> searchJobsByComprehensiveFilters(
            String keyword,
            Integer provinceId,
            Integer districtId,
            Integer categoryId,
            ...
            int page,
            int pageSize) {
        return Collections.singletonList(jobSearchDao.searchJobsByComprehensiveFilters(
                keyword, provinceId, districtId, categoryId, workType,
    ...
    public List<Map<String, Object>> getJobsBySkills(List<Integer> skillIds, int provinceId) {
        return jobSkillDao.getJobsByMultipleSkills(skillIds, provinceId);
    }

    public List<Map<String, Object>> getJobsByCompany(int companyId) {
        return companyDao.getJobsByCompanyId(companyId);
    }
