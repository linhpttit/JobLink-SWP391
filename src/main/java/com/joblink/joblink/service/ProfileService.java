...
public class ProfileService {
    ...
    public int calculateCompletionPercentage(int seekerId) {
        ...
        if (!languageDao.findBySeekerId(seekerId).isEmpty()) done++;
    ...
    public List<String> getMissingSections(int seekerId) {
        ...
        if (skillDao.findBySeekerId(seekerId).isEmpty()) miss.add("Skill");
        if(languageDao.findBySeekerId(seekerId).isEmpty()) miss.add("Language");
