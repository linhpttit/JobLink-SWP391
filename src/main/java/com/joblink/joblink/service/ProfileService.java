...
public class ProfileService {
    ...
    @Transactional
    public JobSeekerProfile getOrCreateProfile(int userId) {
    ...
    @Transactional
    public void updateBasicInfo(JobSeekerProfile profile) {
    ...
    // ========= Skill =========
    public List<Skill> getSkills(int seekerId) { return skillDao.findBySeekerId(seekerId); }
    @Transactional public int  addSkill(Skill s) { return skillDao.create(s); }
    @Transactional public void updateSkill(Skill s) { skillDao.update(s); }
