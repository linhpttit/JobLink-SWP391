...
public class EmailService {
    ...
    /**
     * Gửi email thông báo cho employer khi được chấp nhận hoặc từ chối
     * @param toEmail Email của employer
     * @param companyName Tên công ty
     * @param isAccepted true nếu được chấp nhận, false nếu bị từ chối
     */
