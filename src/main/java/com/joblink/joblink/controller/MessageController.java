    ...
    public ResponseEntity<Map<String, Object>> sendInConversation(
        ...
        try {
            ...
            if ("SEEKER_SEEKER".equalsIgnoreCase(conv.getConversationType())) {
                ...
                JobSeekerProfile p1 = profileService.getProfileBySeekerId(conv.getSeekerId());
                JobSeekerProfile p2 = profileService.getProfileBySeekerId(conv.getSeekerId2());
                if (p1 == null || p2 == null) {
                ...
                JobSeekerProfile seekerP = profileService.getProfileBySeekerId(seekerId);
