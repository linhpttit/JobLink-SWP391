...
public class ChatController {
    ...
    public String chatPage(@PathVariable int otherSeekerId, HttpSession session, Model model) {
        ...
        JobSeekerProfile2 currentProfile = jobSeekerService.getProfileByUserId(user.getUserId());

        // Get other user's profile
        JobSeekerProfile2 otherProfile = jobSeekerService.getProfileBySeekerId(otherSeekerId);
    ...
    public ResponseEntity<Map<String, Object>> sendMessage(
        ...
        try {
            JobSeekerProfile2 senderProfile = jobSeekerService.getProfileByUserId(user.getUserId());
            JobSeekerProfile2 receiverProfile = jobSeekerService.getProfileBySeekerId(receiverSeekerId);
